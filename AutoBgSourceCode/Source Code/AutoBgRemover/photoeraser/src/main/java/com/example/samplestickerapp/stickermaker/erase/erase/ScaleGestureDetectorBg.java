...
public class ScaleGestureDetectorBg {
    ...
    public interface OnScaleGestureListener {
        boolean onScale(View view, ScaleGestureDetectorBg var);

        void onScaleBegin(View view, ScaleGestureDetectorBg var);

        boolean onScaleEnd(View view, ScaleGestureDetectorBg var);
    }
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        ...
        public void onScaleBegin(View view, ScaleGestureDetectorBg var) {
        }
    ...
    public ScaleGestureDetectorBg(OnScaleGestureListener aVar) {
        this.mListener = aVar;
    }
    ...
    private void setContext(View view, MotionEvent motionEvent) {
        ...
        if (findPointerIndex < 0 || findPointerIndex2 < 0 || findPointerIndex3 < 0 || findPointerIndex4 < 0) {
            ...
            if (this.mGestureInProgress) {
                this.mListener.onScaleBegin(view, this);
            }
            return;
        }
    ...
    public boolean onTouchEvent(View view, MotionEvent motionEvent) {
        ...
        if (this.mGestureInProgress) {
            if (actionMasked == 1) {
                ...
                setContext(view, motionEvent);
                this.mGestureInProgress = this.mListener.onScaleEnd(view, this);
                return true;
                ...
                if (pointerCount > 2) {
                    ...
                    if (pointerId == i3) {
                        int a = findNewActiveIndex(motionEvent, this.mActiveId1, actionIndex);
                        if (a >= 0) {
                            this.mListener.onScaleBegin(view, this);
                            this.mActiveId0 = motionEvent.getPointerId(a);
                        ...
                        if (pointerId == this.mActiveId1) {
                            int a2 = findNewActiveIndex(motionEvent, i3, actionIndex);
                            if (a2 >= 0) {
                                this.mListener.onScaleBegin(view, this);
                                this.mActiveId1 = motionEvent.getPointerId(a2);
                                this.mActive0MostRecent = false;
                                this.mPrevEvent = MotionEvent.obtain(motionEvent);
                                setContext(view, motionEvent);
                                this.mGestureInProgress = this.mListener.onScaleEnd(view, this);
    ...
    public float getPreviousSpan() {
        if (this.mScaleFactor == -1.0f) {
            this.mScaleFactor = getScaleFactor() / getCurrentSpan();
        }
